...
const consoleFormat = winston.format.combine(
  winston.format.splat(), // logger.error('%o/%O/%j', err)
...
}) as winston.Logger & Record<keyof (typeof custom)['levels'], winston.LeveledLogMethod> // for typescript with custom levels
